...
Popen(gmx+" mdrun -deffnm ./mini1/mini1 -v -c ./mini1/mini_systeme.gro", shell=True).wait()



Popen("cp ./mini1/mini_systeme.gro ./mini2/")
Popen("cp ./mini1/"+topology+" ./mini2/")
for i in xrange(len(refTemp)):
	...
	Popen(gmx+" grompp -f ./mini2/Equil_"+str(i)+".mdp -c ./mini2/mini_systeme.gro -p ./mini2/"+topology+" -o ./mini2/Equil_"+str(i)+".tpr", shell=True).wait()
	Popen(gmx+" mdrun -v -deffnm ../mini2/Equil_"+str(i), shell=True).wait()

#for((i=0;i<8;i++))
#	do
#		sed "s|ref_t = 300 ; .*|ref_t = ${array_temp[$i]} ;|" Equil.mdp>Equil_$i.mdp
#		gmx_mpi grompp -f Equil_$i.mdp -c mini_systeme.gro -p $top -o Equil_$i.tpr	
#		gmx_mpi mdrun -v -deffnm Equil_$i
#	done

#cd ..
#mkdir REM48h
#cp ./mini2/Equil_* ./REM48h/
#cp ./mini2/*.itp ./REM48h/
#cp ./mini2/*.top ./REM48h/
#cp ./files/md_good.mdp ./REM48h/
#cp ./files/makejobs.sh ./REM48h/
#cp ./files/md_prod1.sh ./REM48h/
#cd ./REM48h/
#
#for((i=0;i<8;i++))
#        do
#                sed "s|ref_t = 300 .*|ref_t = ${array_temp[$i]} ;|" md_good.mdp>md_good_$i.mdp
#                gmx_mpi grompp -f md_good_$i.mdp -c Equil_$i.gro -p $top -o md_good1_$i.tpr
#        done
#rm *#
